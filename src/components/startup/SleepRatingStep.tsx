...
interface SleepRatingStepProps {
...
export default function SleepRatingStep({ initialValue, onNext, onBack }: SleepRatingStepProps) {
  ...
  const handleNextClick = () => {
    if (selectedRating !== null) {
      ...
      // providing the data for this step (sleep_rating).
      onNext({ sleep_rating: selectedRating });
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600">
        How well did you sleep last night? Rate your overall sleep quality.
      </p>
