...
export default function MorningRatingStep({ initialValue, onNext, onBack }: MorningRatingStepProps) {
  ...
  const handleNextClick = () => {
    if (selectedRating !== null) {
      ...
      // providing the data for this step (morning_rating).
      onNext({ morning_rating: selectedRating });
    }
  };
  ...
  return (
    <div className="space-y-6">
      {/* Step Title */}
      <h2 className="text-xl font-semibold text-gray-800">Morning Rating</h2>

      {/* Instructions */}
      <p className="text-gray-600">
        How did your morning go? Rate how intentional you spent your early hours.
      </p>
      ...
      <div className="flex justify-center space-x-2 sm:space-x-4 pt-4">
       ...
       {/* Optional: Add labels below buttons (e.g., 1=Low, 5=High) */}
